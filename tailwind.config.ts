  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        workflow: {
          unresolved: "hsl(var(--workflow-unresolved))",
          confirmed: "hsl(var(--workflow-confirmed))",
          flagged: "hsl(var(--workflow-flagged))",
          locked: "hsl(var(--workflow-locked))",
        },
        data: {
        ...
        evidence: {
          present: "hsl(var(--evidence-present))",
          missing: "hsl(var(--evidence-missing))",
          pending: "hsl(var(--evidence-pending))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
